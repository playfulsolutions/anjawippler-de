    ...
    <Container>
      <Content>
        ...
        <p>Eine Nutzung der Internetseiten der
          Anja Wippler ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine
          ...
          holt Anja Wippler generell eine Einwilligung der betroffenen Person ein.</p>
        ...
        <p>Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der Anschrift, E-Mail-Adresse oder
          ...
          Datenschutzbestimmungen. Mittels dieser Datenschutzerklärung möchte Anja Wippler die Öffentlichkeit über
        ...
        <p>Anja Wippler hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
        ...
        <p>Die Datenschutzerklärung von Anja Wippler beruht auf den Begrifflichkeiten, die durch den
          ...
          zu gewährleisten, möchte Anja Wippler vorab die verwendeten Begrifflichkeiten erläutern.</p>
        ...
        <p>Die Internetseite von Anja Wippler erfasst mit jedem Aufruf der Internetseite durch eine
          ...
          Internetseite, von welcher ein zugreifendes System auf diese Internetseite gelangt (sogenannte Referrer), (4)
        ...
        <p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht Anja Wippler keine
          ...
          werden durch Anja Wippler daher einerseits statistisch und ferner mit dem Ziel
          ausgewertet,
        ...
        <ul style={{ listStyle: "none" }}>
          ...
          <li>
            ...
            <p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von
              personenbezogenen Daten, die bei von Anja Wippler gespeichert sind, veranlassen möchte,
              kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter von Anja Wippler wird veranlassen, dass dem Löschverlangen unverzüglich
              nachgekommen wird.</p>

            <p>Wurden die personenbezogenen Daten von von Anja Wippler öffentlich gemacht und ist Anja Wippler als
              Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
              verpflichtet, so trifft Anja Wippler unter Berücksichtigung der verfügbaren
              Technologie
              ...
              Der Mitarbeiter von Anja Wippler wird im Einzelfall das Notwendige veranlassen.</p>
          </li>
          <li><h3>e) Recht auf Einschränkung der Verarbeitung</h3>
            ...
            <ul style={{ listStyle: "none" }}>
              ...
              <li>Die betroffene Person hat Widerspruch gegen die Verarbeitung gem. Art. 21 Abs. 1 DS-GVO eingelegt und
                es
            ...
            <p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die Einschränkung
              von
              personenbezogenen Daten, die bei von Anja Wippler gespeichert sind, verlangen möchte,
              kann
              sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter von Anja Wippler wird die Einschränkung der Verarbeitung veranlassen.</p>
          </li>
          <li><h3>f) Recht auf Datenübertragbarkeit</h3>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
              ...
              übermitteln, sofern die Verarbeitung auf der Einwilligung gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art.
              9
            ...
            <p>Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person jederzeit an einen
              Mitarbeiter von Anja Wippler wenden.</p>
          ...
          <li>
            ...
            <p>Die Anja Wippler verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht
              mehr, es sei denn, Anja Wippler kann zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die
              den
            ...
            <p>Verarbeitet Anja Wippler personenbezogene Daten, um Direktwerbung zu betreiben, so
              hat
              ...
              Wippler der Verarbeitung für Zwecke der Direktwerbung, so wird Anja Wippler die
            ...
            <p>Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation ergeben,
              gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei von Anja Wippler
              zu
            ...
            <p>Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt jeden Mitarbeiter der
              Anja Wippler oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es
              ferner
          ...
          <li><h3>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</h3>
            ...
            <p>Ist die Entscheidung (1) für den Abschluss oder die Erfüllung eines Vertrags zwischen der betroffenen
              ...
              betroffenen Person, trifft Anja Wippler angemessene Maßnahmen, um die Rechte und
              Freiheiten sowie die berechtigten Interessen der betroffenen Person zu wahren, wozu mindestens das Recht
              auf
              Erwirkung des Eingreifens einer Person seitens des Verantwortlichen, auf Darlegung des eigenen Standpunkts
        ...
        <p>Art. 6 I lit. a DS-GVO dient Anja Wippler als Rechtsgrundlage für Verarbeitungsvorgänge, bei denen wir
          ...
          erforderlich sind, etwa in Fällen von Anfragen zur Produkten oder Leistungen. Unterliegt Anja Wippler
          ...
          wäre
          beispielsweise der Fall, wenn ein Besucher in Anja Wipplers Betrieb verletzt werden würde und daraufhin sein Name,
          ...
          zur Wahrung eines berechtigten Interesses von Anja Wippler oder eines Dritten erforderlich ist, sofern die
        ...
        <h3>8. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder einem Dritten verfolgt
          werden</h3>
        <p>Basiert die Verarbeitung personenbezogener Daten auf Artikel 6 I lit. f DS-GVO ist Anja Wipplers berechtigtes
          Interesse
        ...
        <p>Wir klären Sie darüber auf, dass die Bereitstellung personenbezogener Daten zum Teil gesetzlich
          ...
          beispielsweise verpflichtet uns personenbezogene Daten bereitzustellen, wenn Anja Wippler mit ihr einen
        ...
        <p>Als verantwortungsbewusste Einzelperson verzichtet Anja Wippler auf eine automatische Entscheidungsfindung
        ...
        <p>Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche Gesellschaft für
          Datenschutz GmbH, die als <a
            ...
            Anwalt für Datenschutzrecht Christian Solmecke</a> erstellt.
        </p>
      </Content>
    </Container>
  )
