  ...
  return (
    <ProjectDescription relativeImageDirectory="projects/Dimod">
      ...
      <p>
        ...
        und traditionellen textilen Materialien ein. Prototypen werden experimentell entwickelt und mit Raffinesse in allgemeingültige Schnittmuster übertragen,
        die später individuell angepasst werden. So wird kaschiert, was unsichtbar bleiben soll. Die Schönheit der Persönlichkeit wird hervorgehoben.
      </p>
        Es entstehen Lieblingsstücke statt Problemlösungen. Sie werden gerne getragen, da die Kleidungsstücke nach modischen Wünschen variiert werden können und
