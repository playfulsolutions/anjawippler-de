...
export default () => {
  ...
  return (
    <ProjectDescription relativeImageDirectory="projects/Octopuz">
      <h1 className="title is-size-5">Octo.puz</h1>
      ...
      <p>unique youngstar nominee 2014 und Ausstellung im Rahmen der
        <a href="https://www.spogagafa.de"> spoga+gafa </a>köln.
      </p>
      <p>
        Zeitschrift „Fit for Fun“ Januar 2015, MDR „Einfach Genial“ 2015
      </p>
      <a href="http://octo-puz.blogspot.com">Einblicke in die Projektarbeit.</a>
    </ProjectDescription>
  )
}
